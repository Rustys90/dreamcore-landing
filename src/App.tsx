  ...
  return (
    <div ref={ref} style={{ height: "480vh", position: "relative" }}>
      <div style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden", background: "#0a0608" }}>
        <div style={{ position: "absolute", inset: 0, transform: "scale(" + lerp(1, 1.18, ep) + ")", transformOrigin: "50% 50%" }}>
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 15, transform: "scale(" + lerp(1, 7.5, ep) + ")", transformOrigin: "52% 38%", opacity: portalOpacity }}>
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 20, opacity: scene1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: 24, pointerEvents: scene1 > 0.05 ? "auto" : "none" }}>
          <h1 style={{ fontFamily: "'Viaoda Libre', serif", fontSize: "clamp(36px, 9vw, 88px)", color: "#fff", textShadow: "0 2px 24px rgba(0,0,0,0.7)", margin: 0, letterSpacing: "0.04em" }}>
            FALL <span style={{ color: "rgba(255,220,180,0.7)" }}>›</span> INTO REVERIE
          </h1>
          <p style={{ fontFamily: "'Imprima', sans-serif", fontSize: 18, color: "rgba(255,245,235,0.88)", maxWidth: 360, marginTop: 16, lineHeight: 1.6 }}>
            Crafting boundless digital worlds where the edge between AI, vision, and living myth dissolves.
          </p>
          <div style={{ marginTop: 28, fontSize: 10, letterSpacing: "0.22em", color: "rgba(255,255,255,0.6)", textTransform: "uppercase" }}>DESCEND</div>
        </div>
        <div style={{ position: "absolute", inset: 0, zIndex: 46, opacity: scene2, display: "flex", flexDirection: "column", alignItems: "center", paddingTop: "12vh", pointerEvents: "none" }}>
          <h2 style={{ fontFamily: "'Viaoda Libre', serif", fontSize: "clamp(28px, 6vw, 64px)", color: "#fff", textShadow: "0 2px 20px rgba(0,0,0,0.4)", margin: 0 }}>
            FORGE BEYOND THE REAL
          </h2>
          <p style={{ fontFamily: "'Imprima', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.82)", maxWidth: 480, marginTop: 16, textAlign: "center", lineHeight: 1.6 }}>
